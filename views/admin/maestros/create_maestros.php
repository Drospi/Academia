    ...
    <div id="createMaestro" class="modal fixed w-full h-full top-0 left-0 flex items-center justify-center hidden">
        ...
        <div class="modal-container bg-white w-11/12 md:max-w-md mx-auto rounded shadow-lg z-50 overflow-y-auto">
            <div class="modal-content py-4 text-left px-6">
                ...
                <div class="flex justify-between items-center pb-3">
                    <p class="text-2xl font-bold">Crear Maestro</p>
                ...
                <!-- Contenido del modal -->
                <form action="/maestros/create" id="maestros_form" method="post">
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <select required class="w-full cursor-pointer appearance-none border border-gray-300 p-2 rounded leading-tight focus:outline-none focus:border-blue-500" name="materia" id="materia">
                            <?php
...
<script>
        document.getElementById('createMaestroButton').addEventListener('click', function() {
            document.getElementById('createMaestro').classList.remove('hidden');
        ...
        document.querySelectorAll('.closeModal').forEach(function(close) {
            close.addEventListener('click', function(e) {
                document.getElementById('createMaestro').classList.add('hidden');
                e.preventDefault();
            });
        })
